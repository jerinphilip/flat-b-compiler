...
@C = common global [15625 x i64] zeroinitializer
@B = common global [15625 x i64] zeroinitializer
@A = common global [15625 x i64] zeroinitializer
...
if_block:                                         ; preds = %for_body6
  ...
  %vr23 = load i64, i64* @a
  %vr24 = getelementptr inbounds [15625 x i64], [15625 x i64]* @A, i64 0, i64 %vr23
...
else_block:                                       ; preds = %for_body6
  ...
  %vr30 = load i64, i64* @a
  %vr31 = getelementptr inbounds [15625 x i64], [15625 x i64]* @A, i64 0, i64 %vr30
...
if_block57:                                       ; preds = %for_body45
  ...
  %vr64 = load i64, i64* @a
  %vr65 = getelementptr inbounds [15625 x i64], [15625 x i64]* @B, i64 0, i64 %vr64
...
else_block66:                                     ; preds = %for_body45
  ...
  %vr72 = load i64, i64* @a
  %vr73 = getelementptr inbounds [15625 x i64], [15625 x i64]* @B, i64 0, i64 %vr72
...
for_body95:                                       ; preds = %for_pre94
  ...
  %vr118 = getelementptr inbounds [15625 x i64], [15625 x i64]* @C, i64 0, i64 %vr117
  %vr119 = load i64, i64* %vr118
  %vr120 = load i64, i64* @a
  %vr121 = getelementptr inbounds [15625 x i64], [15625 x i64]* @A, i64 0, i64 %vr120
  %vr122 = load i64, i64* %vr121
  %vr123 = load i64, i64* @b
  %vr124 = getelementptr inbounds [15625 x i64], [15625 x i64]* @B, i64 0, i64 %vr123
  %vr125 = load i64, i64* %vr124
  %vr126 = mul i64 %vr122, %vr125
  %vr127 = add i64 %vr119, %vr126
  %vr128 = load i64, i64* @c
  %vr129 = getelementptr inbounds [15625 x i64], [15625 x i64]* @C, i64 0, i64 %vr128
...
for_body145:                                      ; preds = %for_pre144
  ...
  %vr158 = getelementptr inbounds [15625 x i64], [15625 x i64]* @A, i64 0, i64 %vr157
...
for_body177:                                      ; preds = %for_pre176
  ...
  %vr190 = getelementptr inbounds [15625 x i64], [15625 x i64]* @B, i64 0, i64 %vr189
...
for_body209:                                      ; preds = %for_pre208
  ...
  %vr222 = getelementptr inbounds [15625 x i64], [15625 x i64]* @C, i64 0, i64 %vr221
